/* html page
1. add a text box input element that asks users to type a month to get the number of days in return
2. add a button to submit the user input (create a JS event). could do this other ways, like hit return, but let's go with a button
3. add an element to receive the result of looking up the month's # of days
4. add a link to lab6d.js after the above so... those elements load before the js is accessed in order to pull and push data from the DOM
*/
